...
public class CategoriaDAO implements DAO<Categoria> {
    ...
    public synchronized void create(Categoria categoria) throws PetShopException {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            throw new PetShopException("Errore durante la creazione della categoria", 500, e);
        }
    }
    ...
    public synchronized boolean delete(int id) throws PetShopException {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            throw new PetShopException("Errore durante l'eliminazione della categoria", 500, e);
        }
    ...
    public synchronized Categoria retrieveByKey(int id) throws PetShopException {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            throw new PetShopException("Errore durante il recupero della categoria per chiave", 500, e);
        }
